<template>
  <div class="flex flex-col justify-center w-full h-screen bg-black">
    <h1
      class="p-2 text-2xl font-black tracking-widest text-center text-gray-800 uppercase  bg-gradient-to-r from-black to-gray-800"
    >
      Macbook potencia / precio
    </h1>
    <div class="w-full max-w-5xl px-5 py-1 mx-auto text-xs text-right md:px-1">
      <a
        class="italic text-blue-300 underline"
        href="https://www.youtube.com/watch?v=Vim_SiAdKqA"
        target="_blank"
        rel="noopener noreferrer"
        >ver video
      </a>
    </div>
    <div class="grid px-4 bg-black md:px-10 place-items-center">
      <div
        class="
          w-full
          max-w-5xl
      ...
      >
        ...
        >
          ...
          >
              ...
              >
                ...
                <div>
                  ...
                  <span v-if="i != 0">
                    +{{
                      (
                        (item.info.multi / items[0].info.multi - 1) *
                        100
                      ).toFixed(1)
                    }}
                    %
            ...
            <img
              class="object-cover h-[370px] md:h-[460px] w-full"
    ...
    > -->
      <div class="pt-5 font-thin text-white">
        <a
        ...
        >
          ...
          <span class="block">
            diferencia (16Gb/512Gb) -{{
              -ofertaAmazon + macActual.info.precio
            }}€
          </span>
        </div>
      </div>
